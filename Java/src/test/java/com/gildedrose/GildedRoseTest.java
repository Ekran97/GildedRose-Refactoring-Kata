...
class GildedRoseTest {
    ...
    @Test
    void sulfuras() {
        Item[] items = new Item[] { new Item(GildedRose.SULFURAS, 5, 80) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    @Test
    void conjured() {
        Item[] items = new Item[] { new Item(GildedRose.CONJURED, 5, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
    ...
    void conjured_quality_more_than_50() {
        Item[] items = new Item[] { new Item(GildedRose.CONJURED, 5, 60) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
    ...
    void conjured_quality_less_than_0() {
        Item[] items = new Item[] { new Item(GildedRose.CONJURED, 5, 1) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
        assertEquals(0, items[0].quality);
    ...
    @Test
    void aged_brie() {
        Item[] items = new Item[] { new Item(GildedRose.AGED_BRIE, 5, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
    ...
    void aged_brie_quality_more_than_50() {
        Item[] items = new Item[] { new Item(GildedRose.AGED_BRIE, 5, 60) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
    ...
    void backstage_passe_normal() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES, 20, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstage_passe_sellIn_less_than_10_days() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES, 10, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstage_passe_sellIn_less_than_5_days() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES, 5, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
    ...
    void backstage_passe_after_concert() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES, 0, 5) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
    ...
    void backstage_passe_quality_more_than_50() {
        Item[] items = new Item[] { new Item(GildedRose.BACKSTAGE_PASSES, 5, 60) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals(4, items[0].sellIn);
        assertEquals(50, items[0].quality);
